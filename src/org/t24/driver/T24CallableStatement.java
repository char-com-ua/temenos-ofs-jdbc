...
public class T24CallableStatement extends T24PreparedStatement implements CallableStatement{
	protected T24CallableStatement(T24Connection con,String sql)throws SQLException{
		super(con,sql);
	}
  ...
  //--------------------------JDBC 3.0-----------------------------
     ...
     * in the Java programming language.
     * @par         am parameterName the name of the parameter
     * @return the parameter value.  If the value is SQL <code>NULL</code>, the result 
     * is <code>0</code>.
     * @exception SQLException if a database access error occurs
     * @see #setShort
